...
export const bibliografia = {
  ...
  // -- Combinatoria, geometria, topologia --
  artinZopfe: {
    tipo: 'articolo',
    autori: 'E. Artin',
    titolo: 'Theorie der Zöpfe',
  ...
  hatcherAlgTop: {
    tipo: 'libro',
    autori: 'A. Hatcher',
    titolo: 'Algebraic Topology',
    edizione: { editore: 'Cambridge University Press', citta: 'Cambridge', anno: 2002 }
  },
  lam1991: {
    tipo: 'articolo',
    autori: 'C. W. H. Lam',
    titolo: 'The Search for a Finite Projective Plane of Order 10',
  ...
  mathematicsOfDobble: {
    tipo: 'nota',
    nota: '«The Mathematics of Dobble» — analisi divulgativa della struttura combinatoria del gioco (piani proiettivi finiti).'
  },
